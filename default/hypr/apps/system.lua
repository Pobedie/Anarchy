...
o.window(
  "(org.anarchy.bluetui|org.anarchy.impala|org.anarchy.wiremix|org.anarchy.btop|org.anarchy.terminal|org.anarchy.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|ANARCHY|About|TUI.float|imv|mpv)",
  { tag = "+floating-window" })
o.window(
  {
...
o.window("org.anarchy.screensaver", { fullscreen = true, float = true, animation = "slide" })
...
hl.layer_rule({ match = { namespace = "anarchy-image-selector" }, no_anim = true })
