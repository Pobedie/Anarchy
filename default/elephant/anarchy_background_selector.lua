Name = "anarchyBackgroundSelector"
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/anarchy/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/anarchy/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/anarchy/backgrounds/" .. theme_name)
  end
      ...
      for background in handle:lines() do
        ...
        if filename and not seen[filename] then
          ...
          table.insert(entries, {
            ...
            Value = background,
            Actions = {
              activate = "anarchy-theme-bg-set " .. ShellEscape(background),
            },
            Preview = background,
            PreviewType = "file",
          })
